...
# Import SNBT generation utilities from your provided package
#from gdpc import signBlock, lecternBlock, bookData
...
def addInteriorDecoration(build_area, architectural_style):
    ...
    for _ in range(num_elements):
        ...
        if element_type == "table":
            ...
            lamp_block = mt.lecternBlock(facing="up", bookData=mt.bookData("Modern Floor Lamp"))
